...
public static class MyArray
{
    ...
    public static int AbsValueBiggerThanAverageCount(int[] array)
    {
        double sum = 0;
        ...
        for (int i = 0; i < array.Length; i++)
        {
            if (array[i] < 0 && array[i] * (-1) > averageValue)
            {
                count++;
            }
            else if (array[i] > averageValue)
            {
                count++;
            }
        }
    ...
    public static int[] AbsValueBiggerThanAverage(int[] array)
    {
        double sum = 0;
        double averageValue = 0;
        int count = 0;
        ...
        int[] needeElement = new int[count];
        for (int i = 0; i < array.Length; i++)
        {
            if (array[i] < 0 && array[i] * (-1) > averageValue)
            {
                needeElement[insertIndex] = array[i];
                insertIndex++;
            }
            else if (array[i] > averageValue)
            {
